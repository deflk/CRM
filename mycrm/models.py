...
class Customer(models.Model):
    ...
    source_choices = ((0, '转介绍'), (1, 'qq群'), (2, '官网'), (3, '百度推广'),
                      (4, '51cto'), (5, '知乎推荐'), (6, '市场推广'))
...
class CustomerFollowUp(models.Model):
    ...
    intention_choices = ((0, '2周内报名'), (1, '1个月内报名'), (2, '近期无报名计划'), (3, '已在其他机构报名'),
                         (4, '已报名'), (5, '已拉黑'))
...
class StudyRecord(models.Model):
    ...
    score_choices = ((100, 'A+'), (90, 'A'), (85, 'B+'), (80, 'B'), (75, 'B-'), (70, 'C+'),
                     (60, 'C'), (40, 'C-'), (-50, 'D'), (-100, 'COPY'), (0, 'N/A'))
